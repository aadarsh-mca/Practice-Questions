...
1. import="comma separated list of packaged clasess"
...
If you enable it to true--- WC will supply   'exception' implicit object to this page

Instead of adding errorPage attribute , in page directive of multiple JSPs ,
...
EL syntax to display error mesg
${pageContext.exception.message}
-- evaluates to pageContext.getException().getMessage()
OR
<%= exception.getMessage() %>

${pageContext.exception} - to stirng of exception - name of the exception + error message
...
JSP actions(=tags) ---- commands/messages meant for WC
...
4.1 Request Dispatcher's  forward scenario
