...
public class Flight {
	 ...
	 * @throws SQLException
	 */
	public static Flight getFlight(ResultSet result) throws SQLException {
		return new Flight(result.getInt(1), result.getString(2), result.getString(3), result.getString(4), 
				result.getDate(5), result.getDate(6), result.getTime(7), result.getTime(8), 
				result.getInt(9), result.getDouble(10));
	}
